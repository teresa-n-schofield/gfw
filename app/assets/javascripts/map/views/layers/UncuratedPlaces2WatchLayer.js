...
define(
  ...
  (CartoDBLayerClass, Uncurated2WatchCartocss) => {
    const UncuratedPlaces2WatchLayer = CartoDBLayerClass.extend({
      options: {
        sql:
        ...
        infowindow: true,
        interactivity:
          'cartodb_id, tablename, glad_count, analysis, actions, analize, readmore, grid_id, datestamp, ptw_score',
        analysis: false,
